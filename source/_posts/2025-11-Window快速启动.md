...
> 使用windows电脑的工作场景下，你有没有在思考一个问题的时候，忽然需要查找某个文档里的信息去佐证你的想法，可能这个文档好久没有打开了，一时之间你也没法直接打开，需要用鼠标点点点找在哪个路径下，然后看着似曾相识的文档名字去判断是不是你需要的那个文档，然后找了一大圈后才打开文档，这时你又忘了当时为啥要找这个文档，要查什么信息，那个灵光一闪的idea是啥来着？咱能不能不要老是去找东西，能不能给每个咱们经常用的东西起个名字，在用的时候直接呼唤它的名字打开它呢？经过大量调研，总结，测试，我总结一个方法论，可以实现给任何应用（本质一点说是任何可执行程序）起名字并进行呼唤（调用）的实操方法。
...
![image011.png](https://leo-2019-blog-1259040785.cos.ap-beijing.myqcloud.com/Image/image011.png)

2.将需要快捷打开的文件、文件夹、应用程序**创建桌面快捷方式，并移入此文件夹**；
3.**更改快捷方式名称**，更改后的名字就是后续在win+r命令框中应该输入的命令。

![image012.png](https://leo-2019-blog-1259040785.cos.ap-beijing.myqcloud.com/Image/image012.png)
 
4.将文件夹放在某个文件路径下。（路径随意，只要是在本地就行）

![image013.png](https://leo-2019-blog-1259040785.cos.ap-beijing.myqcloud.com/Image/image013.png)

5.将文件夹路径添加到系统路径中；

![image014.png](https://leo-2019-blog-1259040785.cos.ap-beijing.myqcloud.com/Image/image014.png)
...
![image016.png](https://leo-2019-blog-1259040785.cos.ap-beijing.myqcloud.com/Image/image016.png)

![image017.png](https://leo-2019-blog-1259040785.cos.ap-beijing.myqcloud.com/Image/image017.png)

3.重命名快捷方式并放入上文提到的“winr”文件夹中。

![image018.png](https://leo-2019-blog-1259040785.cos.ap-beijing.myqcloud.com/Image/image018.png)
...
![image025.png](https://leo-2019-blog-1259040785.cos.ap-beijing.myqcloud.com/Image/image025.png){:height="50%" width="50%"}

![image026.png](https://leo-2019-blog-1259040785.cos.ap-beijing.myqcloud.com/Image/image026.png){:height="50%" width="50%"}
